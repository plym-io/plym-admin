...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  },
  {
    id: 'takeaways',
    title: 'Key Takeaways',
    hint: 'The points worth remembering',
    keywords: ['takeaway', 'takeaways', 'key', 'summary', 'tldr', 'recap', 'points'],
    icon: ListChecks,
    // A quote holding a heading and bullets — no syntax of its own, drawn as
    // a card by the takeaways field. One item is enough: Enter carries the
    // "> - " down, and ends the list when an item is left empty.
    run: (c) => insertBlock(c, `> Key Takeaways\n>\n> - ${CARET}\n`),
  },
  {
    id: 'bullets',
    title: 'Bulleted list',
