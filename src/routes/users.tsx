...
import { CONSOLE_SIGNIN_URL } from '@/lib/console';
...
const ROOT_KEY_LABEL = 'Get a sign-in link from plym Cloud';
                ...
                <div className="flex w-16 shrink-0 items-center justify-end gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                  {u.is_active ? (
                    <>
                      ...
                      {u.id === rootUserId ? (
                        <a
                          href={CONSOLE_SIGNIN_URL}
                          target="_blank"
                          rel="noreferrer noopener"
                          title={ROOT_KEY_LABEL}
                          aria-label={ROOT_KEY_LABEL}
