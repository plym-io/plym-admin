...
/**
 * Settings on a self-hosted blog: what the site is currently running, read
 * only. `config.yaml` on the server is the source of truth — a panel that
 * edited it here would be one more place for the two to disagree.
 */
  ...
  return (
    <Page width="text">
      <PageHeader
        ...
        description={
          <>
            What this blog is running now. To change any of it, edit{' '}
            <code className="font-mono text-[13px] text-fg">config.yaml</code> on the
            server and run{' '}
            <code className="font-mono text-[13px] text-fg">plym reload</code>.
          </>
        }
      />
